  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-2 gap-y-5">
        ...
        <label htmlFor="tags">
          ...
          <input
            ...
            id="tags"
            className="block w-full mt-1 py-2 px-3 rounded border focus:border-primary outline-none"
            placeholder="(i.e)., programming, nature, science"
            required
      ...
      <label htmlFor="submit" className="block my-4">
        ...
        <button className="bg-primary hover:bg-primary text-white text-center w-full py-2 rounded active:scale-95 duration-300">
          SUBMIT BLOG
        </button>
      </label>
    </form>
